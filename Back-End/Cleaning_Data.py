...
if __name__ == "__main__":
    ...
    # Structured the cleaned data
    structured_data = normalize_data(cleaned_data)
    ...
    # Save structured data to a JSON file for further use
    try:
        with open("structured_data.json", "w", encoding="utf-8") as f:
            json.dump(structured_data, f, indent=4)
    except Exception as e:
        logging.error(f"Error writing structured_data.json: {e}")
    ...
    print(f"Structured messages: {len(structured_data)}")